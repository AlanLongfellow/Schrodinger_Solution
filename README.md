...
- /notes/ – Extended derivations, side lemmas, curated scratchpad
- /src/ – Python & GNU Octave implementations of the solution
- /src/longfellow_schrodinger/ – Library code
- /src/cli/ – Command-line entry points
- /examples/ – Minimal runnable examples (free particle, harmonic oscillator, step/barrier, time-varying potentials, n-dimensional tests)
